    ...
    <div className="min-h-screen bg-gradient-to-b from-[#FAF7FF] to-[#F3EFFF] flex flex-col px-6 py-8">
      <div className="flex-1 flex flex-col max-w-lg mx-auto w-full">
        <div className="text-center mb-6">
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-[#B8A8D8]/10 rounded-full mb-4">
            <Sparkles className="w-4 h-4 text-[#B8A8D8]" />
            <p className="text-sm text-[#B8A8D8]">PROTOCOL READY</p>
          </div>
          <h2 className="text-xl text-[#4A4458]" style={{ fontFamily: 'var(--font-serif)' }}>
            Your Personal Wellness Protocol
          </h2>
        </div>

        <div className="bg-white rounded-3xl shadow-2xl border-4 border-[#FF8B9E]/30 overflow-hidden mb-6">
          <div className="bg-gradient-to-r from-[#FF8B9E] to-[#FFC4D0] px-6 py-6 text-center relative">
          ...
          <div className="px-6 py-6">
            <div className="mb-6 text-center">
              <div className="inline-flex items-center gap-2 px-4 py-2 bg-[#FF8B9E]/5 rounded-xl mb-2">
                <span className="text-2xl">{protocol.emoji}</span>
                <h3 className="text-lg text-[#4A4458]" style={{ fontFamily: 'var(--font-serif)' }}>
            ...
            <div className="space-y-5">
              <div className="border-l-4 border-[#FF8B9E] pl-4 py-2">
                <div className="flex items-center gap-2 mb-2">
                  <Activity className="w-4 h-4 text-[#FF8B9E]" />
                  <h4 className="text-sm text-[#8B7E9E] tracking-wide">1. THE ACTION (HABUILD CORE)</h4>
                </div>
                <p className="text-[#4A4458] leading-relaxed">{protocol.action}</p>
              </div>

              <div className="border-l-4 border-[#B8A8D8] pl-4 py-2">
                <div className="flex items-center gap-2 mb-2">
                  <Apple className="w-4 h-4 text-[#B8A8D8]" />
                  <h4 className="text-sm text-[#8B7E9E] tracking-wide">2. THE NUTRITION TIP</h4>
                </div>
                <p className="text-[#4A4458] leading-relaxed">{protocol.nutrition}</p>
              </div>

              <div className="border-l-4 border-[#FFC4D0] pl-4 py-2">
                <div className="flex items-center gap-2 mb-2">
                  <Brain className="w-4 h-4 text-[#FFC4D0]" />
                  <h4 className="text-sm text-[#8B7E9E] tracking-wide">3. THE MINDSET HABIT</h4>
                </div>
                <p className="text-[#4A4458] leading-relaxed italic">{protocol.mindset}</p>
              </div>
            </div>

            <div className="mt-6 border-t-2 border-[#F3EFFF] pt-6">
              <div className="bg-gradient-to-br from-[#FF8B9E]/5 to-[#B8A8D8]/5 p-5 rounded-2xl border-2 border-[#FF8B9E]/20">
                <p className="text-sm text-[#4A4458] leading-relaxed mb-4">
            ...
            <div className="mt-6 pt-4 border-t border-[#F3EFFF] flex items-center justify-between">
              <div>
                <p className="text-xs text-[#8B7E9E] mb-1">Chief Health Officer</p>
                <p className="text-[#4A4458]" style={{ fontFamily: 'var(--font-serif)' }}>
                  {data.name}
                </p>
              </div>
              <Award className="w-12 h-12 text-[#FF8B9E]" />
            </div>
          </div>
        </div>
        ...
        <button
          onClick={onShare}
          className="w-full py-5 rounded-2xl bg-[#B8A8D8] text-white hover:bg-[#4A8884] transition-all shadow-xl hover:shadow-2xl hover:-translate-y-0.5"
        >
          Send Protocol to Family
        </button>

        <p className="text-center text-xs text-[#8B7E9E] mt-4">
